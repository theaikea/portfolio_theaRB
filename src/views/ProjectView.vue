...
<template>
  <div class="grid grid-cols-1 sm:grid-cols-2 mt-20 ml-6 gap-5">
    ...
    <p v-if="project.description05Text" class="poppins text-lg pr-3 w-full sm:w-1/3 mt-5 w-4/5"> 
      {{ project.description05Text }} 
    </p>
    ...
    <p v-if="project.description2Text" class="poppins text-lg pr-3 w-full sm:w-1/3 mt-5 w-4/5"> 
    ...
    <p v-if="project.description25Text" class="poppins text-lg pr-3 w-full sm:w-1/3 mt-5 w-4/5"> 
    ...
    <p v-if="project.description3Text" class="poppins text-lg w-full sm:w-1/3 mt-5 w-4/5 pr-3"> 
    ...
    <video v-else-if="project.video5" :src="project.video5" class="mt-5 w-full sm:w-auto col-start-1 w-4/5 pr-6" autoplay muted loop playsinline @click="unmuteAndPlay"></video>

    <p v-if="project.description4Text" class="poppins text-lg w-full sm:w-1/3 mt-5 w-4/5 pr-3"> 
    ...
    <video v-else-if="project.video6" :src="project.video6" class="mt-5 w-full sm:w-auto col-start-1 w-4/5 pr-6" autoplay muted loop playsinline @click="unmuteAndPlay"></video>

    <p v-if="project.description5Text" class="poppins text-lg w-full sm:w-1/3 mt-5 w-4/5 pr-3"> 
      {{ project.description5Text }} 
    </p>

    <p 
  v-if="project.descriptionText2" 
  class="poppins text-xl w-full pr-3 sm:text-2xl mt-5 sm:mt-10 w-full col-start-1" 
  v-html="project.descriptionText2">
</p>
  
  
    <img v-if="project.image7" class="mt-5 w-full sm:w-auto col-start-1 w-4/5 pr-6" :src="project.image7" alt="">
    <video v-else-if="project.video7" :src="project.video7" class="mt-5 w-full sm:w-auto col-start-1 w-4/5 pr-6" autoplay muted loop playsinline @click="unmuteAndPlay"></video>
