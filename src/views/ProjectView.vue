...
<template>
  <div class="grid grid-cols-1 sm:grid-cols-2 mt-20 ml-6 gap-5">
    ...
    <video v-else-if="project.video" :src="project.video" class="mt-5 sm:w-auto col-start-1 w-full pr-6" autoplay muted loop playsinline></video>
  
    <img v-if="project.Image2" class="mt-5 w-full pr-6 sm:w-auto col-start-1 w-4/5" :src="project.Image2" alt="">
    <video v-else-if="project.video2" :src="project.video2" class="mt-5 w-full sm:w-auto col-start-1 w-4/5 pr-6" autoplay muted loop playsinline></video>
  
    <p v-if="project.description2Text" class="poppins text-lg pr-6 w-full sm:w-1/3 mt-5 w-4/5"> 
    ...
    <video v-else-if="project.video3" :src="project.video3" class="mt-5 w-full sm:w-auto col-start-1 w-4/5 pr-6" autoplay muted loop playsinline></video>
  
    <img v-if="project.image4" class="mt-5 w-full sm:w-auto col-start-1 w-4/5 pr-6" :src="project.image4" alt="">
    <video v-else-if="project.video4" :src="project.video4" class="mt-5 w-full sm:w-auto col-start-1 w-4/5 pr-6" autoplay muted loop playsinline></video>
  
    <p v-if="project.description3Text" class="poppins text-lg w-full sm:w-1/3 mt-5 w-4/5 pr-6"> 
    ...
    <video v-else-if="project.video7" :src="project.video7" class="mt-5 w-full sm:w-auto col-start-1 w-4/5 pr-6" autoplay muted loop playsinline></video>
