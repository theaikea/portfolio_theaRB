<template>
  <div class="grid grid-cols-2 gap-8 mt-20 ml-5">
    ...
    <div class="plottervideo w-1/2 h-1/2 col-span-1 row-span-1 relative z-0" style="clip-path: inset(0)">
    ...
    <div class="drawing1 w-1/2 h-1/2 col-span-1 row-span-1 row-start-5 relative">
    ...
    <div class="plakat w-1/2 h-1/2 col-span-1 row-span-1 row-start-6 relative">
